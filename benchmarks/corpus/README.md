...
All entries were downloaded and byte-verified; Meshtastic's stable repin was
verified on 2026-08-31. Their `sha256` and `size` values describe the downloaded
release assets, and their source commits are immutable schema trees resolved
from release tags or an application-pinned schema dependency:
